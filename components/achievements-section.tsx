            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <motion.div 
                    className={`absolute inset-0 m-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-r ${colors.accent} p-[2px] -z-[1000]`}
                    // initial={{ scale: 0.8 }}
                    whileHover={{ scale: 1 }}
                    transition={{ duration: 0.3 }}
                  >
